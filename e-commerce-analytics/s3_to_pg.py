...
RAW_DATA_PREFIX = "raw/"
PROCESSED_DATA_PREFIX = "processed/"  # New prefix for processed Parquet files

# AWS Credentials (consider using environment variables or IAM roles in production)
AWS_ACCESS_KEY_ID = "AKIAYS2NSZDXQYFZMBXH"
AWS_SECRET_ACCESS_KEY = "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"
